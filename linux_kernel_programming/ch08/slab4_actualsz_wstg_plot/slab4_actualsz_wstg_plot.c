/*
 * ch08/slab4_actualsz_wstg_plot/slab4_actualsz_wstg_plot.c
 ***************************************************************
 ...
 ****************************************************************
 * Brief Description:
 * Here, we have slightly modified the ch08/slab4_actualsize LKM to print just
...
MODULE_DESCRIPTION
("LKP2E book:ch08/slab4_actualsz_wstg_plot: test slab alloc with the ksize(), minimal ver");
