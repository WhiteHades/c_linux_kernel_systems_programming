/*
 * solutions_to_assgn/ch09/slab_custom_mult/slab_custom_mult.c
 ***************************************************************
...
MODULE_DESCRIPTION("LKP2E book:solutions_to_assgn/ch09/slab_custom_mult: assigment solution");
