/*
 * ch13/rdwr_concurrent/1_demo_rdwr_nolocks/miscdrv_rdwr_nolocks.c
 ***************************************************************
...
MODULE_DESCRIPTION
("LKP2E book:ch13/rdwr_concurrent/miscdrv_rdwr_nolocks: simple misc char driver demo: concurrent reads/writes with NO locking!");
